...
class GenWarp():
    ...
    def gen_with_warped(
        ...
        # Prepare inputs.
        conditions = self.prepare_conditions_with_warped(**pipe_args, src_warped=warped, src_mask=mask)
    ...
    @torch.no_grad()
    def prepare_conditions_with_warped(
        self,
        src_image: Float[Tensor, 'B C H W'],
        src_depth: Float[Tensor, 'B C H W'],
        rel_view_mtx: Float[Tensor, 'B 4 4'],
        ...
        src_warped: Float[Tensor, 'B C H W'],
        src_mask: Float[Tensor, 'B 1 H W']
